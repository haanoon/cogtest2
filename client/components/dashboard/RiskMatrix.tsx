...
export default function RiskMatrix() {
  ...
  return <div className="rounded-lg border bg-card p-4"><div className="text-sm font-medium mb-2">Risk Matrix</div><ReactECharts option={option} style={{height: 260}} /></div>;
}
